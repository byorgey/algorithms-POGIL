...
\begin{questions}
  ...
  \item $\canAddTo$ takes a \emph{pair} of values as input.  How many
    possible such pairs are there?\marginnote{Of course there are
      infinitely many pairs of numbers; this question is really asking
      about how many inputs to recursive calls we might possibly see
      after starting by calling $\canAddTo(n,S)$.}
