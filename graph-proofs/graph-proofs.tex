...
\begin{lem} \label{lem:onetwothree}
  $(1) \land (2) \implies (3)$.  That is: let $G = (V,E)$ be a graph with $|V|
...
\begin{proof}
  ...
  \begin{itemize}
  \item The base case is when \blank.\linebreak In this case, $G$
    looks like \blank\linebreak which indeed \blank.
  \item For the induction step, suppose $P(k)$ holds for some $k \geq
    ...
    $G'$ is still \blank\linebreak because \blank\linebreak and also still
...
Let's do one more!  (The third is a homework problem.)

\begin{lem}
  $(2) \land (3) \implies (1)$, that is, \blank\linebreak \mbox{}\blank.
\end{lem}
