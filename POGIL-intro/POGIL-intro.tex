...
Learning).\marginnote{\url{https://www.pogil.org}} Before we jump into
...
\begin{questions}
  ...
  \item You get credit for a problem set by completing all the
    problems Dr.\ Yorgey assigned that week.
  ...
  \item One week, Amanda has a play performance, three midterm
    ...
    deadline, or else get a zero on the problem set.
  ...
  \newpage
  \item Attendance is not part of your grade.  However, if you will be
    absent, you should let Dr.\ Yorgey know ahead of time.
  ...
  \item In this course, which of the following could be considered academic
    ...
    \begin{compactenum}[(a)]
      ...
      \item collaborating with another student while preparing for an exam
      \item obtaining a copy of exam questions before an exam
      \item using an LLM (AI) to help generate ideas for problem set solutions
